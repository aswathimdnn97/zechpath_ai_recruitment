...
from document_processing.job_description.heading import job_description_headings
...
def job_description_pipeline(file):
    ...
    # fixed handle_layout
    handled_jd=fix_layout(normalized_jd)
    
    # parse_jd
    parsed_jd=parse_document(handled_jd,job_description_headings)
